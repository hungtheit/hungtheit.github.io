                    ...
                    function (t) {
                      for (; ; ) switch (t.prev = t.next) {
                        case 0:
                          ...
                          c = screen.colorDepth,
                          u = Array.from(navigator.plugins || []).map((function (t) {
                            return t.name
                          })).join(','),
                          f = navigator.hardwareConcurrency ||
                          0,
                          s = navigator.deviceMemory ||
                          0,
                ...
                function (n, a) {
                  !function n(o, i, a, c) {
                    ...
                    if ('throw' !== u.type) {
                      ...
                      return l &&
                      'object' == typeof l &&
                      e.call(l, '__await') ? r.resolve(l.__await).then(
                        (function (t) {
                          n('next', t, a, c)
                        }),
                        (function (t) {
      ...
      function x(t, r) {
        ...
        if (void 0 === e) {
          if (r.delegate = null, 'throw' === r.method) {
            if (
              t.iterator.return &&
              (r.method = 'return', r.arg = void 0, x(t, r), 'throw' === r.method)
            ) return s;
            r.method = 'throw',
      ...
      function E(t) {
        if (t) {
          ...
          if (!isNaN(t.length)) {
            var n = - 1,
            i = function r() {
              for (; ++n < t.length; ) if (e.call(t, n)) return r.value = t[n],
              r.done = !1,
              r;
      ...
      _.prototype = {
        ...
        reset: function (t) {
          if (
            ...
            !t
          ) for (var r in this) 't' === r.charAt(0) &&
          e.call(this, r) &&
          !isNaN( + r.slice(1)) &&
          (this[r] = void 0)
        },
